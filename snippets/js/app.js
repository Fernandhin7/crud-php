    ...
    methods: {
        ...
        getId() {
            ...
            if (uri.length == 2) {
                ...
                axios.get('http://localhost:8090/crud-php/snippets/api/crud/getId.php?id=' + this.itemId.id)
                    .then(res => {
        ...
        eliminar(id) {
            swal({
                ...
                .then((aceptar) => {
                    if (aceptar) {
                        axios.get('http://localhost:8090/crud-php/snippets/api/crud/eliminar.php?id=' + id)
                            .then(res => {
                                if (res.data == 'success') {
                                    swal('post eliminado')
                                    this.getCategoria()
        ...
        getUser() {
            axios.get('http://localhost:8090/crud-php/snippets/api/crud/getUser.php')
                .then(res => {
        ...
        getCategoria() {
            ...
            if (uri.length == 2) {
                ...
                this.itemId = getVars
                console.log(this.itemId.id)
                axios.get('http://localhost:8090/crud-php/snippets/api/crud/getCategoria.php?cat=' + this.itemId.cat)
                    .then(res => {
                        this.listar = res.data
                    })
            } else {
                axios.get('http://localhost:8090/crud-php/snippets/api/crud/getPost.php')
                    .then(res => {
                        this.listar = res.data
                    })
            }
